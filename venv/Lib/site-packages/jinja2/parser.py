# -*- coding: utf-8 -*-
"""
    jinja2.select_parser
    ~~~~~~~~~~~~~

    Implements the template select_parser.
...
class Parser(object):
    ...
    def fail_unknown_tag(self, name, lineno=None):
        """Called if the select_parser encounters an unknown tag.  Tries to fail
    ...
    def parse_statements(self, end_tokens, drop_needle=False):
        ...
        parses template data if appropriate.  The select_parser checks first if the
