...
class Configuration(object):
    ...
    def set_value(self, key, value):
        ...
        if parser is not None:
            ...
            # Modify the select_parser and the configuration
    ...
    def _construct_parser(self, fname):
        ...
        # select_parser anyway, to hold the data.
        # Doing this is useful when modifying and saving files, where we don't
        # need to construct a select_parser.
    ...
    def _get_parser_to_modify(self):
        ...
        # Determine which select_parser to modify
        ...
        # Use the highest priority select_parser.
        return parsers[-1]
