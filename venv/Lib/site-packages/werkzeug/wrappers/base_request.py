...
class BaseRequest(object):
    ...
    #: The form data select_parser that shoud be used.  Can be replaced to customize
    ...
    def make_form_data_parser(self):
        """Creates the form data select_parser. Instantiates the
    ...
    def stream(self):
        ...
        .. versionchanged:: 0.9
           ...
           form select_parser later on.  Previously the stream was only set if no
           parsing happened.
        """
        _assert_not_shallow(self)
    ...
    def get_data(self, cache=True, as_text=False, parse_form_data=False):
        ...
        of this method will be an empty string if the form select_parser handles
        the data.  This generally is not necessary as if the whole data is
        cached (which is the default) the form select_parser will used the cached
