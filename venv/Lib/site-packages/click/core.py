...
class BaseCommand(object):
    ...
    parsing methods that do not depend on the Click select_parser.
    ...
    def parse_args(self, ctx, args):
        """Given a context and a list of arguments this creates the select_parser
...
class Command(BaseCommand):
    ...
    def make_parser(self, ctx):
        """Creates the underlying option select_parser for this command."""
